...
const OnboardingWizard: React.FC<OnboardingWizardProps> = ({ onFinish }) => {
    ...
    const handleGenerate = () => {
        ...
        if ((financeConfig?.count || 0) > 0) {
            ...
            categories.push({ id: genId(), name: 'Finances', color: '#6366f1', icon: 'Wallet', items });
        }
        ...
        if ((homeConfig?.count || 0) > 0) {
            ...
            categories.push({ id: genId(), name: 'Immobilier', color: '#14b8a6', icon: 'Home', items });
        }
        ...
        if ((healthConfig?.count || 0) > 0) {
            ...
            categories.push({ id: genId(), name: 'Santé', color: '#10b981', icon: 'Activity', items });
        }
