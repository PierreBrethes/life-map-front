...
const AnimatedLine: React.FC<AnimatedLineProps> = ({ start, end, color, dep, isSelected, onSelect, onDelete }) => {
  ...
  return (
    <group>
      {dependencies.map((dep) => {
        ...
        const startPos = getItemWorldPosition(dep.fromCategory, dep.fromItem, data, dep.fromId);
        const endPos = getItemWorldPosition(dep.toCategory, dep.toItem, data, dep.toId);
